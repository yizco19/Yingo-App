...
class CarRecyclerViewAdapter(private var carList: List<Car>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        car.product_image?.let { holder.productImage.setImageResource(it) }
        holder.productName.text = car.product_name
        holder.productPrice.text = car.product_price.toString()
